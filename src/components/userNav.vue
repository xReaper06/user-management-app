      ...
      <div class="container-fluid">
        ...
        >
          <ul class="navbar-nav">
            <li
              class="nav-item"
              :class="{ 'active-link': isActive('/user/userDashboard') }"
            >
              <router-link to="/user/userDashboard" class="nav-link text-white"
                ><svg
            ...
            <li
              class="nav-item"
              :class="{ 'active-link': isActive('/user/profile') }"
            >
