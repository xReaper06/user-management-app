<template>
    <div>
        ...
        >
           ...
           <div class="card-body">
            ...
            <div style="display:flex; justify-content:center; align-items:center;">
                <img :src="`http://localhost:8081/api/images/${profile.image}`" alt="" class="img-fluid" style="height: 100px; width: 100px; border-radius: 50%; " >
            </div>
            <div class="align-items-center justify-content-center text-center mt-2">
                <button
                    type="button"
            ...
            <hr>
            <div class="fs-3 text-center"><strong>
        ...
        <hr>
           ...
           <change-pass-modal @closeChangePassModal="closeChangePassModal" :show-change-pass-modal="showChangePassModal"/>
           <change-profile @closeProfileModal="closeProfileModal"  :get-profile="getProfile" :show-profile-modal="showProfileModal"/>
           <change-info @closeInfoModal="closeInfoModal" :info="info" @restartInfo="restartInfo" :show-info-modal="showInfoModal"/>
        </div>
    </div>
</template>
